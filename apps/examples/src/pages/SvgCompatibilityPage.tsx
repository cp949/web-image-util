...
export function SvgCompatibilityPage() {
  ...
  // SVG 처리 함수
  const processSvg = useCallback(async (inputSvg: string) => {
    if (!inputSvg.trim()) {
      setEnhancedSvg('')
      setReport(null)
      setError('')
  ...
  return (
    <Container maxWidth="lg">
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
        브라우저 간 SVG 호환성 문제를 실시간으로 해결해보세요. 네임스페이스, 크기 정보, 현대적 문법 등을 자동으로 개선합니다.
      </Typography>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, addNamespaces: e.target.checked })
                        }
                      />
                    }
                    label="네임스페이스 추가"
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, fixDimensions: e.target.checked })
                        }
                      />
                    }
                    label="크기 정보 수정"
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, addPreserveAspectRatio: e.target.checked })
                        }
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, preferResponsive: e.target.checked })
                        }
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, ensureNonZeroViewport: e.target.checked })
                        }
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setOptions({ ...options, enableHeuristicBBox: e.target.checked })
                        }
                      />
                    }
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{xs:6, sm:3}}>
                      <Box sx={{ textAlign: 'center' }}>
                        ...
                        <Typography variant="h6">
                          {report.processingTimeMs.toFixed(2)}ms
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid size={{xs:6, sm:3}}>
                    ...
                    <Grid size={{xs:6, sm:3}}>
                      <Box sx={{ textAlign: 'center' }}>
                        ...
                        <Typography variant="body2">
                          {report.addedNamespaces.length > 0
                            ? report.addedNamespaces.join(', ')
                            : '없음'}
                        </Typography>
                      </Box>
                    </Grid>
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                      ...
                      <Tooltip title="복사">
                        <IconButton
                          size="small"
                          onClick={() => copyToClipboard(svgInput)}
                        >
                          <ContentCopy />
                        </IconButton>
                      </Tooltip>
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                      ...
                      <Tooltip title="복사">
                        <IconButton
                          size="small"
                          onClick={() => copyToClipboard(enhancedSvg)}
                          disabled={!enhancedSvg}
                        >
                          <ContentCopy />
                        </IconButton>
                      </Tooltip>
