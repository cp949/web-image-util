              ...
              <CardContent>
                ...
                <Stack spacing={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">
                      File 객체로 변환. FormData와 함께 서버 업로드에 최적화.
                    </Typography>
                  </Box>
                </Stack>
              </CardContent>
          ...
          <Stack spacing={3}>
                          ...
                          <TableRow key={index}>
                            <TableCell>
                              <Chip
                                label={result.type}
                                color={
                                  result.type === 'blob' ? 'primary' :
                                  result.type === 'dataURL' ? 'secondary' : 'success'
                                }
                                size="small"
                              />
                            </TableCell>
              ...
              <Card>
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Data URL 길이: {(results.find(r => r.type === 'dataURL')?.data as string)?.length.toLocaleString()} 문자
                  </Typography>
                </CardContent>
              </Card>
            )}
            ...
            <Alert severity="info">
              <Typography variant="body2">
                ...
                • Data URL은 Base64 인코딩으로 인해 원본보다 약 33% 더 큽니다<br/>
                • 대용량 이미지는 Blob을 사용하는 것이 메모리 효율적입니다<br/>
                • File 객체는 FormData 업로드에 최적화되어 있습니다
              </Typography>
            </Alert>
          </Stack>
        </Grid>
