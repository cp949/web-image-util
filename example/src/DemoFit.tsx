    ...
    return (
        <Box className="DemoFit-root" sx={rootSx}>
            ...
            <Container maxWidth="md" fixed>
                <Stack direction="row">
                    <Box flex={1}>
                        <Box className="DemoFit-sectionHeader">박스보다 작은 이미지</Box>
                        <Box className="DemoFit-sectionImageInfo">
                            <div>
                        ...
                        <Box className="DemoFit-sectionImageBox">
                    ...
                    <Box flex={1}>
                        <Box className="DemoFit-sectionHeader">박스보다 큰 이미지</Box>
                        <Box className="DemoFit-sectionImageInfo">
                            <div>
