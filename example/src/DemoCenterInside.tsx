...
import { Box, Button, Checkbox, Container, FormControlLabel, Stack, SxProps } from "@mui/material";
...
const rootSx: SxProps = {
    ...
    "& .DemoCenterInside-sectionHeader": {
        background: "#f0f0f0",
        color: "primary.main",
        textAlign: "center",
        py: 1,
    ...
    "& .DemoCenterInside-sectionImageInfo": {
        mt: 1,
        fontSize: "0.8rem",
        display: "flex",
    ...
    "& .DemoCenterInside-sectionImageBox": {
        position: "relative",
...
export default function DemoCenterInside() {
    ...
    return (
        <Box className="DemoCenterInside-root" sx={rootSx}>
            ...
            <Box sx={{ textAlign: "center" }}>
                <FormControlLabel
                    label="TRIM"
                    control={<Checkbox checked={trim ?? false} onChange={(e) => setTrim(e.target.checked)} />}
                />
            </Box>
            ...
            <Container maxWidth="md" fixed>
                <Stack direction="row">
                    <Box flex={1}>
                        <Box className="DemoCenterInside-sectionHeader">박스보다 작은 이미지</Box>
                        <Box className="DemoCenterInside-sectionImageInfo">
                            <div>
                        ...
                        <Box className="DemoCenterInside-sectionImageBox">
                    ...
                    <Box flex={1}>
                        <Box className="DemoCenterInside-sectionHeader">박스보다 큰 이미지</Box>
                        <Box className="DemoCenterInside-sectionImageInfo">
                            <div>
