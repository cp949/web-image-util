...
export default function DemoForceHeight() {
    ...
    useEffect(() => {
        if (sourceElement) {
            Images.simpleResizer
                .forceHeight(sourceElement, size)
    ...
    return (
        <Box className="DemoForceHeight-root" sx={[rootSx]}>
            <Box sx={{ py: 1 }}>
                <Typography variant="h5">Demo Images.simpleResizer.forceHeight()</Typography>
            </Box>
            <Grid container columnSpacing={2}>
                <Grid item xs={12} md={4}>
                    <Box>
                        <Box className="DemoForceHeight-sliderBox">
                            <span className="DemoForceHeight-sliderLabel">최대 높이</span>
                            ...
                            />
                            <span className="DemoForceHeight-sliderValue">{size}</span>
                        </Box>
                    </Box>
                </Grid>
