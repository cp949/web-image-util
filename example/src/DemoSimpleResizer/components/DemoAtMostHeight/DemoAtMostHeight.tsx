...
export default function DemoAtMostHeight() {
    ...
    useEffect(() => {
        if (sourceElement) {
            Images.simpleResizer
                .atMostHeight(sourceElement, size)
    ...
    return (
        <Box className="DemoAtMostHeight-root" sx={[rootSx]}>
            <Box sx={{ py: 1 }}>
                <Typography variant="h5">Demo Images.simpleResizer.atMostHeight()</Typography>
            </Box>
            <Grid container columnSpacing={2}>
                <Grid item xs={12} md={4}>
                    <Box>
                        <Box className="DemoAtMostHeight-sliderBox">
                            <span className="DemoAtMostHeight-sliderLabel">최대 높이</span>
                            ...
                            />
                            <span className="DemoAtMostHeight-sliderValue">{size}</span>
                        </Box>
                    </Box>
                </Grid>
