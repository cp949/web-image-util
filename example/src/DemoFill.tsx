    ...
    return (
        <Box className="DemoFill-root" sx={rootSx}>
            ...
            <Container maxWidth="md" fixed>
                <Stack direction="row">
                    <Box flex={1}>
                        <Box className="DemoFill-sectionHeader">박스보다 작은 이미지</Box>
                        <Box className="DemoFill-sectionImageInfo">
                            <div>
                        ...
                        <Box className="DemoFill-sectionImageBox">
                    ...
                    <Box flex={1}>
                        <Box className="DemoFill-sectionHeader">박스보다 큰 이미지</Box>
                        <Box className="DemoFill-sectionImageInfo">
                            <div>
