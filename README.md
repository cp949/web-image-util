...
- `확대하지는 않습니다.` 지정한 사각형 보다 작은 이미지의 경우, 사각형의 중앙에 배치하며, 확대하지는 않습니다. 확대하지 않는 것이 다음에 설명할 `fit`과의 차이점입니다.
...
- 이미지의 일부가 잘리지 않습니다.
- 지정한 사각형 보다 큰 이미지의 경우 축소됩니다.
- 여기까지는 `centerInside`와 동일합니다. `fit`은 지정한 사각형 보다 작은 이미지의 경우, 사각형 크기만큼 확대됩니다. `centerInside`는 확대하지 않습니다.
