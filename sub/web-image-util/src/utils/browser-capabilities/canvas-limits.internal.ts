 ...
 * fallback은 probe가 값을 못 내는 알 수 없는 UA에 적용하는 가장 보수적인 값이다.
 * navigator 부재 시에는 기존 getMaxSafeDimension()과 동일하게 ReferenceError를 던진다.
 */
...
/** probe가 값을 못 내는 알 수 없는 UA의 단일 fallback이다. */
