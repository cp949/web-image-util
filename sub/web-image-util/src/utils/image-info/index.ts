 ...
 * 책임은 다음 4개 서브모듈로 나뉜다.
 * - {@link ./types}            공개 타입 정의
 * - {@link ./format-detection.internal} 입력 소스 기반 포맷 감지
 * - {@link ./dimensions.internal}       치수/비율/방향 추출
 * - {@link ./remote-fetch.internal}     원격 URL fetch + SSRF 가드
 *
...
import { getImageDimensions } from './dimensions.internal';
import { getImageFormat } from './format-detection.internal';
import type { ImageInfo } from './types';

export { getImageAspectRatio, getImageDimensions, getImageOrientation } from './dimensions.internal';

export { getImageFormat } from './format-detection.internal';
export { fetchImageFormat, fetchImageSourceBlob } from './remote-fetch.internal';
export type {
